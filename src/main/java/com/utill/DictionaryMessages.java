...
public class DictionaryMessages {
        ...
        public final static String WORD_UPDATED_SUCCESSFULLY = "Word successfully updated:";
        public final static String NEW_WORD_SUCCESSFULLY_ADDED = "New word added";
        public final static String WORD_DELETED_SUCCESSFULLY = "Word successfully deleted:";
