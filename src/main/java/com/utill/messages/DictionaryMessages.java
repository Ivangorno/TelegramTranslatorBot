...
public class DictionaryMessages {
        public final static String ENTERED_NOT_CORRECT_ENGLISH_WORD = "ERROR: Incorrect english letter or Dictionary Command entered. Please enter an english word to translate";
        public final static String ENTERED_NOT_CORRECT_FRENCH_WORD = "ERROR: Incorrect french letter or Dictionary Command entered. Please enter an english word to translate";
